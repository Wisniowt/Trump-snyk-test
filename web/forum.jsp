            ...
            <div id="content">
               ...
               out.print("Anonymous");
                ...
                <%        if (con != null && !con.isClosed()) {
                            ...
                            PreparedStatement ps = con.prepareStatement("INSERT INTO posts(content,title,user) VALUES (?,?,?)");
                ...
                <% if (con != null && !con.isClosed()) { %>
                    <%  Statement stmt = con.createStatement();
                        ...
                        %>    
                            ...
                            <tr>
                                <td>
                                    <a href="forumposts.jsp?postid=<%=rs.getString("id")%>">
                                        <c:out value="<%=rs.getString("title")%>"/>
                                    </a>
                                </td>
                                <td> 
